...
public class MainActivity extends Activity {
    ...
    public void Pow(View view) {
         Double op1=Double.parseDouble(mOperandOneEditText.getText().toString());
        Double op2=Double.parseDouble(mOperandTwoEditText.getText().toString());
        double p=mCalculator.pow(op1,op2);
        mResultTextView.setText(String.valueOf(p));
